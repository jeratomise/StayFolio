...
import { Newspaper, ExternalLink, RefreshCw, Rss, AlertCircle } from 'lucide-react';
...
export const HotelIntel: React.FC = () => {
  ...
  // Don't render anything if loading failed or no articles
  if (loading) {
    return (
  ...
  if (error || articles.length === 0) {
    return null; // Silently hide if no data — no broken states
  }
